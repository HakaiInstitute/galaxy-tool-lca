# galaxy-tool-lca
A tool to determine the lowest common ancestor from BLAST results with taxonomy. This approach is partly based on MEGAN's (Huson et al., 2007) LCA method. This tool does not specifically use taxonids or separated mapping files. Instead, the script handles files with the taxonomy present in the last column of the input file. Those input files can be generated with our BLAST pipeline or you can create them manually. This fork has been modified to produce LCA assignments for species rank as well as the other taxonomic ranks already operated on in the original repo.

## Installation
### Manual
Clone this repo in your Galaxy ***Tools*** directory:  
`git clone https://github.com/hakaigenomics/galaxy-tool-lca`  
...
`  - repo: https://github.com/hakaigenomics/galaxy-tool-lca`  
&ensp;&ensp;`file: lca.xml`  
&ensp;&ensp;`version: master`  

Information on tool usage, parameters and examples can be found [here](https://github.com/hakaigenomics/galaxy-tool-lca/blob/master/usage.md)  
